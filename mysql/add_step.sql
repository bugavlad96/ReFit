...
CREATE PROCEDURE add_step(
    ...
    p_exercise_category varchar(255),
...
BEGIN
	...
	INSERT INTO photo (id, path, category_name)
		...
		INSERT INTO step (id, exercise_id, photo_id, description, permissive_error, step_order)
		VALUES (unique_id, p_exercise_id, unique_id_photo, p_description, p_permissive_error, p_step_order);
